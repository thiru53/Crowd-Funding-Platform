...
--
-- Host: localhost    Database: doctormanagement_db
-- ------------------------------------------------------
...
CREATE TABLE `doctor_schedule` (
  ...
  `end_time` time DEFAULT NULL,
  `start_time` time DEFAULT NULL,
  KEY `FKne64fr43e23vvgs63mik1tsjb` (`doctor_id`),
  CONSTRAINT `FKne64fr43e23vvgs63mik1tsjb` FOREIGN KEY (`doctor_id`) REFERENCES `doctors` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `patients` (
  ...
  `last_visited_doctor_id` bigint DEFAULT NULL,
  `name` varchar(255) NOT NULL,
...
-- Dump completed on 2023-08-15 17:53:20